...
Contexto:
Hoje os providers podem gerar roteiro sem um contrato suficiente forte. O modelo precisa receber um prompt base padronizado com regras fixas do GalFlowAI.
