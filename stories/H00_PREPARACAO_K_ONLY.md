...
- Variáveis de ambiente apontam para K:.
- Script de validação mostra espaço livre do K:.
- Nenhum arquivo é gravado em C:.
- Logs são gravados em K:\AI_VIDEO_COMMERCIAL_STUDIO\logs.
