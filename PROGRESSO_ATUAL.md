...
- `test_api_endpoints_new.py` - 9 testes (parcial)
...
⚠️ Itens 4-5 do backlog (testes criados, alguns erros)
⚠️ Itens 9-10 do backlog (testes criados, erros de sintaxe)
