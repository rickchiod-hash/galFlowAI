...
O FlowForgeAI (antigamente galFlowAI) foi redesenhado para funcionar **100% sem API key** e **100% offline**.
...
6. No FlowForgeAI, verá: "Motor usado: LMStudioProvider"
...
**Versão:** FlowForgeAI 1.0 - Local-First Architecture
