...
| GAP-014 | Hardcoded K:\ paths em 10 arquivos de código | GAL-938 | 23 ocorrências substituídas por app.config | ✅ Concluído — removido S41 |
...
| GAP-010 | async wrappers sobre sync blocking calls | GAL-937 | `provider_router.py`, `script_service.py`, `provider_strategy.py` | ✅ Concluído — convertido sync em S40 |
