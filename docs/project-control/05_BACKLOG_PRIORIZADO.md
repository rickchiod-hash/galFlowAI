...
| 2 | GAL-937 | Eliminar async wrappers falsos sobre chamadas sync bloqueantes — converter async def para def em provider_router, provider_strategy, script_service | Média | 5 | Em andamento | Nenhuma |
