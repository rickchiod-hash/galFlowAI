...
O FlowForgeAI agora suporta **briefings de fantasia** com templates especializados que geram roteiros comerciais (não narrativas de RPG).
...
O FlowForgeAI rejeita roteiros que contenham:
