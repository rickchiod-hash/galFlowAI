...
echo Iniciando galFlowAI... > logs\app.log
echo Data: %date% %time% >> logs\app.log
"K:\AI_VIDEO_COMERCIAL_STUDIO\envs\studio\python.exe" run_galFlowAI.py >> logs\app.log 2>&1
